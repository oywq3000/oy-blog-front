export default {
  ...
  profile: {
    ...
    avatarCropHint: '拖动图片调整位置，滚轮 / 双指缩放',
    avatarZoomIn: '放大',
    avatarZoomOut: '缩小',
    avatarReset: '还原',
    avatarCancel: '取消',
    ...
    avatarTooLarge: '图片大小不能超过 10MB',
    avatarTooSmall: '图片宽高至少 200px',
    avatarDecodeFailed: '图片解析失败，请重新选择',
  ...
  creator: {
    ...
    publish: '发布',
    lastModified: '最后修改',
    deleteConfirm: '确定要删除「{title}」吗？删除后无法恢复。',
    publishConfirm: '确定要发布「{title}」吗？',
    deleteSuccess: '删除成功',
    publishSuccess: '发布成功',
    status: '状态',
    reviewing: '审核',
    ...
    reviewingRejected: '已驳回',
    emptyReviewing: '暂无审核中的文章',
    reviewReasonTitle: '审核信息',
    reviewReason: '审核理由',
    noReviewReason: '暂无审核理由',
    emptyPublished: '还没有发布文章，点击「创作文章」开始写作吧',
    emptyDrafts: '暂无草稿',
    prev: '上一页',
    next: '下一页',
    title_column: '标题',
    ...
    columnCreated: '专栏创建成功',
    columnUpdated: '专栏已更新',
    deleteColumnConfirm: '确定删除专栏「{name}」吗？专栏下文章的关联会被解除（文章本身不受影响）。',
    // 专栏作者专属编辑页（Task 19）
    backToColumns: '返回专栏管理',
    columnMembers: '专栏文章',
    addArticles: '添加文章',
    removeMember: '移除',
    removeMemberConfirm: '确定把「{title}」移出本专栏吗？',
    moveUp: '上移',
    moveDown: '下移',
    emptyColumnMembers: '本专栏还没有文章，点「添加文章」收录你的已发布文章',
    columnLoadFailed: '专栏信息加载失败',
    columnRetry: '重试',
    columnForbidden: '该专栏不存在或你没有编辑权限',
    archived: '已归档',
    ...
    addModalSubmit: '添加',
    addResultTitle: '添加结果',
    addResultAdded: '已添加 {count} 篇',
    skippedHeading: '以下文章未能添加：',
    noneAdded: '所选文章均未新增（可能已在专栏中）',
    done: '完成',
    skipCode: {
      limit3: '该文章已加入 3 个专栏，未能添加',
      not_published: '该文章尚未发布',
      not_owner: '该文章不是你的',
      not_found: '该文章不存在或已删除',
    },
  },
  articleDetail: {
    views: '阅读',
  ...
  search: {
    ...
    dateTo: '到',
    reset: '重置',
    resultsFor: '找到 {count} 条关于 "{keyword}" 的结果',
    resultsForTag: '找到 {count} 条标签为 "{keyword}" 的结果',
    resultsForAuthor: '找到 {count} 条作者 "{keyword}" 的结果',
    resultsAll: '找到 {count} 条结果',
    noResults: '未找到结果',
    noResultsHint: '请尝试不同的关键词或筛选条件。',
    readyToExplore: '准备探索？',
    readyToExploreHint: '从侧边栏选择一个话题或输入关键词搜索。',
  },
  articles: {
    1: {
